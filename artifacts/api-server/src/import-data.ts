...
import {
  db, pool, usersTable, servicesTable, testimonialsTable, settingsTable,
  quotationsTable, notificationsTable, cashbackTransactionsTable,
} from "@workspace/db";
...
async function run() {
  ...
  for (const n of notifications) {
    await db.insert(notificationsTable).values({
      ...
      set: { title: String(n.title), message: String(n.message), isRead: Boolean(n.is_read) },
    });
  }
  ...
  const newAccounts = [
    { fullName: "Super Admin Kynaz", email: "superadmin@kynaz.com", phone: "0100000001", password: "SuperAdmin@2024", role: "superadmin" as const, referralCode: "SUPER001" },
    { fullName: "Admin Kynaz 2",     email: "admin2@kynaz.com",     phone: "0100000002", password: "Admin@2024",      role: "admin"      as const, referralCode: "ADMIN002" },
    { fullName: "Agent Kynaz",       email: "agent@kynaz.com",      phone: "0100000003", password: "Agent@2024",      role: "agent"      as const, referralCode: "AGENT001" },
    { fullName: "Customer Demo",     email: "customer@kynaz.com",   phone: "0100000004", password: "Customer@2024",   role: "customer"   as const, referralCode: "CUST001"  },
  ];
